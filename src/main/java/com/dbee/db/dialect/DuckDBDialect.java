...
public class DuckDBDialect implements DatabaseDialect {
    @Override public DatabaseType getType() { return DatabaseType.DUCKDB; }
    ...
    @Override public boolean supportsExplainAnalyze() { return true; }
    @Override public String getExplainAnalyzeQuery(String sql) { return "EXPLAIN ANALYZE " + sql; }
}
